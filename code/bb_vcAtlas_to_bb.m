...
hemisphere = {'lh','rh'};
atlas_name = 'rosenke_vcAtlas';
colorfile = '/biac2/kgs/anatomy/freesurferRecon/fsAverage/label/rosenke_vcAtlas/VentralStreamColorLUT.txt';

for h = 1:1 %length(hemisphere)
    cd('/biac2/kgs/anatomy/freesurferRecon/babySegmentations/fsAverage/label/rosenke_vcAtlas/')
   ...
   for s = 1:length(subj)
       ...
       rawlabeldir = ['/biac2/kgs/anatomy/freesurferRecon/babySegmentations/' subj{s} '/label/'];
        labeldir = ['/biac2/kgs/anatomy/freesurferRecon/babySegmentations/' subj{s} '/label/' atlas_name '/'];
        mkdir(labeldir)
        niidir = ['/biac2/kgs/anatomy/freesurferRecon/babySegmentations/' subj{s} '/label/nii/' atlas_name '/'];
        mkdir(niidir)
        ...
        for a = 1:length(area)
            ...
            command = [ 'mri_label2label ' ...
                ...
                '--srclabel /biac2/kgs/anatomy/freesurferRecon/babySegmentations/fsAverage/label/' atlas_name '/' area(a).name ...
                ' --trgsubject ' subj{s} ...
       ...
       unix(command);
        ...
        command = ['mris_label2annot --s ', subj{s}, ' --h ', hemisphere{h}, ' --ctab ' colorfile, labels, ' --a ', atlas_name '_fixed' ];
        unix(command)
