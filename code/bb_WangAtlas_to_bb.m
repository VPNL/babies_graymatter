...
subj = {'bb07_mri0', 'bb07_mri6' 'bb08_mri6' , 'bb11_mri3' 'bb11_mri5' , 'bb14_mri0'}
        ...
        hemisphere = {'lh','rh'};
cd('/biac2/kgs/anatomy/freesurferRecon/babySegmentations/fsAverage/label/wangAtlas/')
atlasname = 'wangAtlas'; % name of resulting annotation file
colorfile = '/biac2/kgs/anatomy/freesurferRecon/fsAverage/label/wangAtlas/wangColorLUT.txt';
%area = {'MPM_FG1'	'MPM_FG2'	'MPM_FG3'	'MPM_FG4'	'MPM_hOc1'	'MPM_hOc2'	'MPM_hOc3v'	'MPM_hOc4v'};
    ...
    for s = 1:length(subj)
        ...
        for a = 1:length(area)
          ...
          unix(command);
            ...
            %save same labels in label directory to be able to create
            %annotation file
