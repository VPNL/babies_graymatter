...
% this code is useful for generating Figure 4 and Supplementary Figure 8. This produces figures related to development in R1 in the first 6 months of life in the ventral visual stream
%%%%%%%% models %%%%%%%%
...
Vent_R.All_T1 = 1./Vent_R.All_T1
Vent_L.All_T1 = 1./Vent_L.All_T1
...
Y = [reshape(Vent_L.All_T1, 1, 240) reshape(Vent_R.All_T1, 1, 240)];
age_subj= [1 2 3  1 2 3  1 2 3  1 2 3 2 3 1 2 3  1 2 3 1 2 3 2 3 1 1 2 3 1];
AGE = [repmat(age_subj, 1, 16)];
roi =[ones(1,30)*1 ones(1,30)*2 ones(1,30)*3 ones(1,30)*4 ones(1,30)*5  ones(1,30)*6 ones(1,30)*7 ones(1,30)*8 ];
ROIS = [roi roi];
HEMI =[ones(1, 240)*1 ones(1, 240)*2];
...
set(gcf, {'DefaultAxesXColor','DefaultAxesYColor'}, {'k' 'k'});
set(gcf,'color','white'); hold;
axis([0 11 0.0003 0.00085]); title('random intercept/fixed Slope')
for i=1:length(roi_list)
...
set(gcf, {'DefaultAxesXColor','DefaultAxesYColor'}, {'k' 'k'});
set(gcf,'color','white'); hold;
axis([0 11 0.4 0.6]); title('random intercept/fixed Slope')
for i=1:length(roi_list)
