%% for visualization of the labels PHC1, PHC2, Cos-places, and Collateral sulcus on each individual babies' brains using Freesurfer's Freeview visualization tool.
